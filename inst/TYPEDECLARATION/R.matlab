...
type `[[` <symbol> => double;
type `as.character.Matlab` <null, ???> => character;
...
type `finalize.Matlab` <null, ???> => null;
...
type `readBinMat` <symbol, double[] | raw[], double, double, ? logical, character> => double[] | raw[];
...
type `readMat4Header` <symbol, ? integer[]> => struct<`ocode`:double, `what`:double[], `size`:integer, `signed`:null, `matrixType`:character, `mrows`:integer, `ncols`:integer, `imagf`:integer, `namlen`:integer>;
...
type `sapply0` <integer[], any => any, ???> => character[];
type `setOption.Matlab` <null, character> => null;
type `setVerbose.Matlab` <null, double, ???> => double;
type `shortenRawBuffer` < > => null;
type `startServer.Matlab` <null, null, environment, logical, character[], character, ???> => integer;
...
type `writeAll` <? integer, struct<`A`:^integer[]> | struct<`data`:struct<`A`:integer[], `X`:integer[]>> | struct<`E`:^character[]> | struct<`e`:character[]> | struct<`F`:^complex[]> | struct<`value`:double[]> | struct<`x`:double> | struct<`X`:integer[]> | struct<`x`:struct<`a.b`:double, `c_d`:double, `e_f.g`:double, `x`:double>>> => double;
type `writeArrayFlags` <character, logical, logical, logical> => double;
type `writeArrayName` <character> => double;
type `writeBinMat` <? integer, double[], double, logical, character> => double;
type `writeCellArrayDataElement` <character, ^character[]> => double;
type `writeCharArray` <character, character> => double;
type `writeCharMat` <? integer, character, integer> => integer;
type `writeCharPart` <character> => double;
type `writeDataElement` <? integer, character | tuple<^double[]> | struct<`a.b`:double> | struct<`A`:^integer[]> | struct<`B`:^integer[]> | struct<`c_d`:double> | struct<`C`:integer[]> | struct<`C`:^logical[]> | struct<`D`:integer[]> | struct<`data`:struct<`A`:integer[], `X`:integer[]>> | struct<`e_f.g`:double> | struct<`E`:^character[]> | struct<`e`:character[]> | struct<`F`:^complex[]> | struct<`value`:double[]> | struct<`x`:double> | struct<`X`:integer[]> | struct<`x`:struct<`a.b`:double, `c_d`:double, `e_f.g`:double, `x`:double>>, ? character | language | double> => double;
...
type `writeHeader` <? integer> => double;
type `writeMat.default` <character | integer, ^character[] | ^complex[] | struct<`a.b`:double, `c_d`:double, `e_f.g`:double, `x`:double> | struct<`A`:integer[], `X`:integer[]>, logical, character, ? any => any, double | environment | ???> => double;
type `writeMat5` <integer, struct<`A`:^integer[]> | struct<`data`:struct<`A`:integer[], `X`:integer[]>> | struct<`E`:^character[]> | struct<`e`:character[]> | struct<`F`:^complex[]> | struct<`value`:double[]> | struct<`x`:double> | struct<`X`:integer[]> | struct<`x`:struct<`a.b`:double, `c_d`:double, `e_f.g`:double, `x`:double>>, ? any => any, character> => double;
